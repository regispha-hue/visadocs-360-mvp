...
- [ ] T010 Add or verify tenant isolation checks for all server-side data access
- [ ] T011 Add or verify audit logging, versioning, responsible user, timestamp, and document status foundations
- [ ] T012 Document migration safety, rollback/mitigation, and local verification commands for database changes
...
- [ ] T021 [US1] Verify RT review/approval gates for generated or regulatory artifacts, if applicable
- [ ] T022 [US1] Verify no improper regulatory claims, secrets, tenant data, or personal data leak through UI, logs, exports, prompts, or generated files
...
- [ ] TXXX Review public copy against docs/regulatory-positioning-policy.md
- [ ] TXXX Prepare delivery evidence: modified files, rationale, risks, verification commands, and next steps
...
- Each tenant-scoped story should verify server-side tenant isolation, auth, audit, and data segregation
- Generated POPs, RQs, manuals, trainings, certificates, evidence, and regulatory documents must remain drafts or operational records until RT approval
