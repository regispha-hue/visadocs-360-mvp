...
- **Tenant data touched**: [Which tenant-scoped data is read, written, exported,
  indexed, trained on, or generated]
- **Roles and approvals**: [Which roles can act, which actions require RT review
  or approval, and what blocks unapproved use]
- **Document status lifecycle**: [Draft/review/approved/current/obsolete/rejected
  states or N/A]
- **Audit evidence**: [Events, actor, timestamp, version, status, and source records
  required for traceability]
- **Regulatory copy constraints**: [Claims/disclaimers needed; reference
  docs/regulatory-positioning-policy.md for public text]
